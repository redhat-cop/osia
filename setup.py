...
setup(
    ...
    description="Openshift infra automation",  # Optional
    ...
    # project.
    author="Miroslav Jaros",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="mirek@mijaros.cz",  # Optional
    ...
    # https://packaging.python.org/guildes/distributing-packages-using-setuptools/#python-requires
    python_requires=">=3.6",
